    ...
    static parseSearch(html, searchTerm) {
        ...
        if ($('h3').length > 0) {
            ...
            liElements.each(function () {
                ...
                let entry = new HowLongToBeatEntry_1.HowLongToBeatEntry(detailId, gameName, gameImage, timeLabels, main, mainExtra, complete, HowLongToBeatParser.calcDistancePercentage(gameName, searchTerm));
                results.push(entry);
            });
        }
        return results;
