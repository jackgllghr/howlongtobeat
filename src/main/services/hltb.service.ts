import { HowLongToBeatProvider } from "./provider";
...
export class HowLongToBeatService {
  ...
  async getDetail(gameId: string): Promise<HowLongToBeatEntry> {
    return this.provider
      ...
      .then(detailPage => HowLongToBeatParser.parseDetails(detailPage, gameId));
  }
  ...
  async search(
    ...
    return this.provider
      ...
      .then(searchPage => HowLongToBeatParser.parseSearch(searchPage, query));
  }
}
